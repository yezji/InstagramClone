...
//    private val TAG = javaClass.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val downloadUriList = mutableListOf<MediaURL>()
...
//        Log.d(TAG, "imageList size: ${strImageList.size}")
//        for (idx in 0 until strImageList.size) Log.d(TAG, "imageList elem: $idx, ${strImageList[idx]}")
